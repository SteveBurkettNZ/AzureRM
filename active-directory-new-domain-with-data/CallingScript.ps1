...
$URI       = 'https://raw.githubusercontent.com/SteveBurkettNZ/active-directory-new-domain-with-data/master/azuredeploy.json'
$Location  = 'West US'
$rgname    = 'emslab11rg'
$saname    = 'emslab11sa'     # Lowercase required
$addnsName = 'emslab11ad'     # Lowercase required
